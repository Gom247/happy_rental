  ...
  <script src="{{ asset('home/vendor/datatables/jquery.dataTables.js') }}"></script>
  <script src="{{ asset('home/vendor/datatables/dataTables.bootstrap4.js') }}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{ asset('home/js/sb-admin.min.js') }}"></script>
